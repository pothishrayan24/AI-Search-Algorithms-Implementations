...
if __name__ == '__main__':
    ...
    path_astar1, explored_astar1 = astar_search(graph_neighbours, '0', '61')
    print("Path_astar:", path_astar1)
    print("Explored Nodes A Star: ", explored_astar1)
    print(len(explored_astar1))
    print()
    print("============ AStar Search geographical ================")
    path_astar, explored_astar = astar_search1(graph_neighbours, '0', '61')
